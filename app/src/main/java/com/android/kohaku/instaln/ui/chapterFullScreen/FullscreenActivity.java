 ...
 */
public class FullscreenActivity extends AppCompatActivity implements ModalBottom.ModalListener {
    ...
    @Override
    public void dummyClicked(String string) {
        Log.v("monis", "dummyClicked " + string);
    }
